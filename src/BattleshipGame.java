...
public class BattleshipGame {
    public static void main(String[] args){
        ...
        while (undetectedShipNumber > 0) {
            ...
            char locationViewUpdate = evaluateAndGetTheTarget(guessCoordinates, gameBoard, ship, water, hit, miss);
    ...
    private static char evaluateAndGetTheTarget(int[] guessCoordinates, char[][] gameBoard, char ship, char water, char hit, char miss) {
        String message;
        int row = guessCoordinates[0];
        int column = guessCoordinates[1];
    ...
    private static int[] getUserCoordinates(int gameBoardLength) {
        ...
        } while (column < 1 || column > gameBoardLength + 1);
